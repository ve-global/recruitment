...
*/
function DataCollector(map_entry, collector_pool) {
    /*
    id: 1,
    selector: '#email',
    attribute: 'value',
    ...
    */
    ...
    DataCollector.pre_validate_mapping(map_entry);  // can throw exceptions
...
/*
    attach to HTML page
*/
DataCollector.prototype.attach = function (document_, reporter) {
    // var elem = document_.getElementById('email');
    let dom_elements = DataCollector._parse_selector(this.map_entry.selector, document_);
...
DataCollector.prototype.getEventName = function() {
...
*/
DataCollector._parse_selector = function(selector_name, document_) {
...
DataCollector.prototype.process_event = function (event, dom, reporter) {
    console.log('Event process', event);
    if (! reporter instanceof classes.DataReporter) {
        // console.error("bug!");
    }
...
*/
DataCollector.prototype.extractData = function(dom) {
...
*/
DataCollector.pre_validate_mapping = function (mapping) {
